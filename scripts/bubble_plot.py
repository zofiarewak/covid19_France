...
fig.update_layout(
    ...
    height=680, 
    margin=dict(t=70, b=160, l=70, r=40),
...
fig.update_xaxes(tickfont=dict(size=16), gridcolor='rgba(200, 200, 200, 0.3)', title_font=dict(size=22))
fig.update_yaxes(tickfont=dict(size=16), gridcolor='rgba(200, 200, 200, 0.3)', title_font=dict(size=22))
...
fig.layout.sliders[0].currentvalue.font = dict(size=18, color="#222", weight="bold")
